...
source.include_patterns = assets/*,csv/*
...
requirements = python3,kivy==2.0.0rc4, git+https://github.com/kivymd/KivyMD.git@master,sdl2_ttf==2.0.15,matplotlib==3.1.3,pandas,xlrd
...
presplash.filename = %(source.dir)s/ic_launcher2.png
